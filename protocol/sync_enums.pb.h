...
void SYNC_EXPORT protobuf_AddDesc_sync_5fenums_2eproto();
...
SYNC_EXPORT bool SyncEnums_SingletonDebugEventType_IsValid(int value);
...
SYNC_EXPORT bool SyncEnums_PageTransition_IsValid(int value);
...
SYNC_EXPORT bool SyncEnums_PageTransitionRedirectType_IsValid(int value);
...
enum SyncEnums_ErrorType {
  ...
  SyncEnums_ErrorType_ACCESS_DENIED = 1,
  SyncEnums_ErrorType_NOT_MY_BIRTHDAY = 2,
  SyncEnums_ErrorType_THROTTLED = 3,
  SyncEnums_ErrorType_AUTH_EXPIRED = 4,
  SyncEnums_ErrorType_USER_NOT_ACTIVATED = 5,
  SyncEnums_ErrorType_AUTH_INVALID = 6,
...
SYNC_EXPORT bool SyncEnums_ErrorType_IsValid(int value);
...
SYNC_EXPORT bool SyncEnums_Action_IsValid(int value);
...
SYNC_EXPORT bool SyncEnums_DeviceType_IsValid(int value);
...
SYNC_EXPORT bool SyncEnums_GetUpdatesOrigin_IsValid(int value);
...
const SyncEnums_GetUpdatesOrigin SyncEnums_GetUpdatesOrigin_GetUpdatesOrigin_MAX = SyncEnums_GetUpdatesOrigin_RETRY;
const int SyncEnums_GetUpdatesOrigin_GetUpdatesOrigin_ARRAYSIZE = SyncEnums_GetUpdatesOrigin_GetUpdatesOrigin_MAX + 1;

// ===================================================================

class SYNC_EXPORT SyncEnums : public ::google::protobuf::MessageLite {
 public:
  SyncEnums();
  virtual ~SyncEnums();
  ...
  static const ErrorType ACCESS_DENIED = SyncEnums_ErrorType_ACCESS_DENIED;
  ...
  static const ErrorType AUTH_EXPIRED = SyncEnums_ErrorType_AUTH_EXPIRED;
  static const ErrorType USER_NOT_ACTIVATED = SyncEnums_ErrorType_USER_NOT_ACTIVATED;
  static const ErrorType AUTH_INVALID = SyncEnums_ErrorType_AUTH_INVALID;
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_EXPORT protobuf_AddDesc_sync_5fenums_2eproto_impl();
  #else
  friend void SYNC_EXPORT protobuf_AddDesc_sync_5fenums_2eproto();
  #endif
